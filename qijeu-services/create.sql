...
create sequence seq_id_utilisateur start 1 increment 50
    ...
    alter table utilisateur 
       ...
       foreign key (statut_id) 
       references parametre
create sequence seq_id_client start 1 increment 1
create sequence seq_id_competition start 1 increment 1
create sequence seq_id_equipe start 1 increment 1
create sequence seq_id_param start 1 increment 1
create sequence seq_id_qijeu start 1 increment 1
create sequence seq_id_qijeu_resultat start 1 increment 1
create sequence seq_id_question start 1 increment 1
create sequence seq_id_questionnaire start 1 increment 1
create sequence seq_id_support start 1 increment 1
create sequence seq_id_theme start 1 increment 1
create sequence seq_id_utilisateur start 1 increment 1
